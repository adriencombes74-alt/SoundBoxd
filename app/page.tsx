...
export default function Home() {
    ...
    const ReviewCard = ({ review }: { review: any }) => {
        ...
        return (
            <div className="group relative bg-[#121212] rounded-2xl border border-white/5 hover:border-[#00e054]/50 transition-all duration-300 hover:-translate-y-1 hover:z-50 hover:shadow-xl flex flex-col h-full">
    ...
    const TopItemCard = ({ item, rank, type }: { item: any, rank: number, type: 'album' | 'song' }) => (
        <Link href={`/album-view?id=${item.albumId || item.id}`} className="group relative block animate-in fade-in zoom-in duration-500 hover:z-50">
...
">
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8 relative z-10 space-y-12 md:space-y-20">
                ...
                <section>
                    ...
                    {topAlbums.length > 0 ? (
                        <>
                            <div className="flex gap-3 md:gap-6 overflow-x-auto py-10 -my-8 px-1 scrollbar-hide">
                ...
                <section>
                    ...
                    <div className="flex gap-4 md:gap-6 overflow-x-auto scrollbar-hide py-10 -my-8 px-1">
                        {loading ? (
