                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-black/50 border border-white/10 rounded-2xl px-5 py-4 text-white focus:border-[#00e054] outline-none transition"
                                        value={newPhone}
                                        onChange={(e) => setNewPhone(e.target.value)}
                                    />
                                    <p className="text-[10px] text-gray-500 ml-3">
                                        Votre numéro ne sera pas vérifié par SMS et ne sera pas visible publiquement.
                                    </p>
                                </div>
